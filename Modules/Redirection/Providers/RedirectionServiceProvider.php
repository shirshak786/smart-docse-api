...
class RedirectionServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            __DIR__.'/../Config/config.php' => config_path('redirection.php'),
        ], 'config');
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'redirection'
        );
    }
    ...
    {
        $viewPath = resource_path('views/modules/redirection');
    ...
    {
        $langPath = resource_path('lang/modules/redirection');
